...
optimize_pdf(){
  ...
  gs -q -dNOPAUSE -dBATCH -dSAFER -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/default -dEmbedAllFonts=true -dSubsetFonts=true -dColorpdfDownsampleType=/Bicubic -dColorpdfResolution=144 -dGraypdfDownsampleType=/Bicubic -dGraypdfResolution=144 -dMonopdfDownsampleType=/Bicubic -dMonopdfResolution=144 -dAutoRotatePages=/None -sOutputFile=$path $path_original 
